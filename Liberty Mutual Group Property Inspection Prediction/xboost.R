...
bst2a <- xgb.train(params = param, data = xgtrain, feval = evalgini, nround=num_rounds, print.every.n = 50, watchlist=watchlist, early.stop.round = 100, maximize = TRUE)
...
bst2b <- xgb.train(params = param, data = xgtrain, nround=num_rounds, print.every.n = 50, watchlist=watchlist, early.stop.round = 100, maximize = FALSE)
