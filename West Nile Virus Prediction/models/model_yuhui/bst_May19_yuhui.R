...
train[train$WnvPresent == 0, "WnvPresent"] <- -1
...
model <- bst(train.cv[, c("Week", "Species", "Block", "TrapNumber", "Latitude", "Longitude", "NumMosquitos", "NumMosqSum")], train.cv$WnvPresent, learner = "tree")
...
## model <- bst(train.cv[, c("Week", "Species", "Block", "TrapNumber", "Latitude", "Longitude", "NumMosquitos", "NumMosqSum", "Tmax", "Tavg", "DewPoint", "Sunrise", "Sunset", "ResultSpeed", "ResultDir", "AvgSpeed")], train.cv$WnvPresent, learner = "tree")
