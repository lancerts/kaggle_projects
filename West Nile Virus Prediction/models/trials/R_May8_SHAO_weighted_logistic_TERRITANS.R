...
vSpecies[vSpecies=="UNSPECIFIED CULEX"]<-"CULEX TERRITANS"
...
write.csv(submissionFile,"submission/weighted_four_factors_CULEX TERRITANS.csv",row.names=FALSE,quote=FALSE)